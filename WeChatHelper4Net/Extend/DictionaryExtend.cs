...
namespace WeChatHelper4Net.Extend
{
	...
	public static class DictionaryExtend
	{
		...
		/// <param name="dictionarys">参数（键值对）字典</param>
		/// <returns></returns>
		public static string ToURLParameter(this System.Collections.Generic.Dictionary<string, string> dictionarys)
		{
		...
		public static string ToXml(this System.Collections.Generic.Dictionary<string, string> dictionarys, string RootTag = "xml")
		{
			StringBuilder sb = new StringBuilder();
			foreach (System.Collections.Generic.KeyValuePair<string, string> pair in dictionarys)
			{
