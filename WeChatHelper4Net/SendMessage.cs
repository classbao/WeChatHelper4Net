...
namespace WeChatHelper4Net
{
    ...
    public class SendMessage
    {
        ...
        /// <returns></returns>
        private static string urlToUser(DateTime now)
        {
        ...
        /// 发送客服消息接口，http请求方式: POST
        /// </summary>
        //private static string urlToUser = Common.ApiUrl + string.Format("message/custom/send?access_token={0}", AccessToken.GetAccessToken(now));
        ...
        public static RequestResultBaseModel TextToUser(string openid, string textContent, DateTime now)
        {
            ...
            string result = HttpRequestHelper.Request(urlToUser(now), data, HttpRequestHelper.Method.POST, System.Text.Encoding.UTF8);
            RequestResultBaseModel model = JsonHelper.DeSerialize<RequestResultBaseModel>(result);
            if (model != null)
            {
                model.url = urlToUser(now);
                model.date = data;
            }
        ...
        /// <returns>RequestResultBaseModel</returns>
        public static RequestResultBaseModel ImageToUser(string openid, string MediaId, DateTime now)
        {
        ...
        /// <param name="MediaId">发送的图片的媒体ID</param>
        /// <returns>RequestResultBaseModel</returns>
        public static RequestResultBaseModel VoiceToUser(string openid, string MediaId, DateTime now)
        {
            if (string.IsNullOrEmpty(openid) || string.IsNullOrEmpty(MediaId)) return new RequestResultBaseModel();
        ...
        /// <returns>RequestResultBaseModel</returns>
        public static RequestResultBaseModel VideoToUser(string openid, string MediaId, string title, string description, DateTime now)
        {
            if (string.IsNullOrEmpty(openid) || string.IsNullOrEmpty(MediaId)) return new RequestResultBaseModel();
        ...
        /// <returns>RequestResultBaseModel</returns>
        public static RequestResultBaseModel MusicToUser(string openid, string title, string description, string musicurl, string hqmusicurl, string thumb_media_id, DateTime now)
        {
        ...
        /// <returns>RequestResultBaseModel</returns>
        public static RequestResultBaseModel NewsToUser(string openid, List<NewsModel> news, DateTime now)
        {
        ...
        /// <param name="now"></param>
        /// <returns></returns>
        private static string urlToGroup(DateTime now)
        {
            return Common.ApiUrl + string.Format("message/mass/sendall?access_token={0}", AccessToken.GetAccessToken(now));
        }
        /// <summary>
        /// 根据分组进行群发接口，http请求方式: POST
        /// </summary>
        //private static string urlToGroup = Common.ApiUrl + string.Format("message/mass/sendall?access_token={0}", AccessToken.GetAccessToken(now));
        ...
        /// <returns>RequestResultBaseModel</returns>
        public static RequestResultBaseModel NewsToGroup(int groupId, string mediaId, DateTime now)
        {
            ...
            data = data.Replace("GroupId", groupId.ToString())
                .Replace("MediaId", mediaId);
            string result = HttpRequestHelper.Request(urlToGroup(now), data, HttpRequestHelper.Method.POST, System.Text.Encoding.UTF8);
            RequestResultBaseModel model = JsonHelper.DeSerialize<RequestResultBaseModel>(result);
            if (model != null)
            {
                model.url = urlToGroup(now);
                model.date = data;
            }
            return model != null ? model : new RequestResultBaseModel();
        }
        ...
        /// <returns>RequestResultBaseModel</returns>
        public static RequestResultBaseModel TextToGroup(int groupId, string textContent, DateTime now)
        {
        ...
        /// <param name="mediaId">用于群发的消息的media_id</param>
        /// <returns>RequestResultBaseModel</returns>
        public static RequestResultBaseModel VoiceToGroup(int groupId, string mediaId, DateTime now)
        {
            if (groupId < 1 || string.IsNullOrEmpty(mediaId)) return new RequestResultBaseModel();
        ...
        /// <param name="mediaId">用于群发的消息的media_id</param>
        /// <returns>RequestResultBaseModel</returns>
        public static RequestResultBaseModel ImageToGroup(int groupId, string mediaId, DateTime now)
        {
            if (groupId < 1 || string.IsNullOrEmpty(mediaId)) return new RequestResultBaseModel();
        ...
        public static ArticleResultModel UploadNews(List<ArticleModel> articles, DateTime now)
        {
            if (articles.Count < 1) return new ArticleResultModel();
            if (articles.Count > 10) throw new Exception("一个图文消息支持1到10条图文。");
            string url = Common.ApiUrl + string.Format("media/uploadnews?access_token={0}", AccessToken.GetAccessToken(now));
        ...
        /// <param name="now"></param>
        /// <returns></returns>
        private static string urlToUserList(DateTime now)
        {
            return Common.ApiUrl + string.Format("message/mass/send?access_token={0}", AccessToken.GetAccessToken(now));
        }
        /// <summary>
        /// 根据OpenID列表群发消息接口，http请求方式: POST
        /// </summary>
        //private static string urlToUserList = Common.ApiUrl + string.Format("message/mass/send?access_token={0}", AccessToken.GetAccessToken(now));
        ...
        public static RequestResultBaseModel TextToUser(string[] openid, string textContent, DateTime now)
        {
            ...
            data = data.Replace("OpenIdList", JsonHelper.Serialize<string[]>(openid))
                .Replace("TextContent", textContent);
            string result = HttpRequestHelper.Request(urlToUserList(now), data, HttpRequestHelper.Method.POST, System.Text.Encoding.UTF8);
            RequestResultBaseModel model = JsonHelper.DeSerialize<RequestResultBaseModel>(result);
            if (model != null)
            {
                model.url = urlToUserList(now);
                model.date = data;
            }
            return model != null ? model : new RequestResultBaseModel();
        }
        ...
        /// <returns>RequestResultBaseModel</returns>
        public static RequestResultBaseModel NewsToUser(string[] openid, string mediaid, DateTime now)
        {
        ...
        /// <returns>RequestResultBaseModel</returns>
        public static RequestResultBaseModel Delete(long msgid, DateTime now)
        {
            string url = Common.ApiUrl + string.Format("message/mass/delete?access_token={0}", AccessToken.GetAccessToken(now));
        ...
        /// <param name="now"></param>
        /// <returns></returns>
        private static string urlToTemplateMessage(DateTime now)
        {
            return Common.ApiUrl + string.Format("message/template/send?access_token={0}", AccessToken.GetAccessToken(now));
        }
        ...
        /// <param name="now"></param>
        /// <returns></returns>
        public static RequestResultBaseModel Template(Models.TemplateMessage.WorkRemind msg, DateTime now)
        {
            ...
            string result = HttpRequestHelper.Request(urlToTemplateMessage(now), data, HttpRequestHelper.Method.POST, System.Text.Encoding.UTF8);
            RequestResultBaseModel model = JsonHelper.DeSerialize<RequestResultBaseModel>(result);
            if (model != null)
            {
                model.url = urlToTemplateMessage(now);
                model.date = data;
        ...
        /// <param name="now"></param>
        /// <returns></returns>
        public static RequestResultBaseModel Template(Models.TemplateMessage.PaymentSuccess msg, DateTime now)
        {
            if (msg == null || string.IsNullOrEmpty(msg.touser)) return new RequestResultBaseModel();
        ...
        /// <param name="now"></param>
        /// <returns></returns>
        public static RequestResultBaseModel Template(Models.TemplateMessage.CustomerMessageNotice msg, DateTime now)
        {
            if (msg == null || string.IsNullOrEmpty(msg.touser)) return new RequestResultBaseModel();
        ...
        /// <param name="now"></param>
        /// <returns></returns>
        public static RequestResultBaseModel Template(Models.TemplateMessage.PapersIncludedNotice msg, DateTime now)
        {
            if (msg == null || string.IsNullOrEmpty(msg.touser)) return new RequestResultBaseModel();
        ...
        /// <param name="now"></param>
        /// <returns></returns>
        public static RequestResultBaseModel Template(Models.TemplateMessage.MeetingReminder msg, DateTime now)
        {
            if (msg == null || string.IsNullOrEmpty(msg.touser)) return new RequestResultBaseModel();
        ...
        /// <param name="now"></param>
        /// <returns></returns>
        public static RequestResultBaseModel Template(Models.TemplateMessage.Track msg, DateTime now)
        {
            if (msg == null || string.IsNullOrEmpty(msg.touser)) return new RequestResultBaseModel();
        ...
        /// <param name="now"></param>
        /// <returns></returns>
        public static RequestResultBaseModel Template(Models.TemplateMessage.DynamicNotice msg, DateTime now)
        {
            if (msg == null || string.IsNullOrEmpty(msg.touser)) return new RequestResultBaseModel();
        ...
        /// <param name="now"></param>
        /// <returns></returns>
        public static RequestResultBaseModel Template(Models.TemplateMessage.ActivitiesJoinNotice msg, DateTime now)
        {
            if (msg == null || string.IsNullOrEmpty(msg.touser)) return new RequestResultBaseModel();
        ...
        /// <param name="now"></param>
        /// <returns></returns>
        public static RequestResultBaseModel Template(Models.TemplateMessage.ExchangeFeedbackNotice msg, DateTime now)
        {
            if (msg == null || string.IsNullOrEmpty(msg.touser)) return new RequestResultBaseModel();
        ...
        /// <param name="now"></param>
        /// <returns></returns>
        public static RequestResultBaseModel Template(Models.TemplateMessage.ProfessorUpdateNotice msg, DateTime now)
        {
            if (msg == null || string.IsNullOrEmpty(msg.touser)) return new RequestResultBaseModel();
        ...
        /// <param name="now"></param>
        /// <returns></returns>
        public static RequestResultBaseModel Template(Models.TemplateMessage.ActivityParticipantsReminder msg, DateTime now)
        {
            if (msg == null || string.IsNullOrEmpty(msg.touser)) return new RequestResultBaseModel();
        ...
        /// <param name="now"></param>
        /// <returns></returns>
        public static RequestResultBaseModel Template(Models.TemplateMessage.WorkNotice msg, DateTime now)
        {
            if (msg == null || string.IsNullOrEmpty(msg.touser)) return new RequestResultBaseModel();
        ...
        /// <param name="now"></param>
        /// <returns></returns>
        public static RequestResultBaseModel Template(Models.TemplateMessage.LotteryResultsNotice msg, DateTime now)
        {
            if (msg == null || string.IsNullOrEmpty(msg.touser)) return new RequestResultBaseModel();
