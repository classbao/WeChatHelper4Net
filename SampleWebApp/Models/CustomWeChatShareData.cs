...
public class CustomWeChatShareData<T> where T : class
{
    /// <summary>
    /// 微信分享类容
    /// </summary>
    ...
    public CustomWeChatShareData(T currentUser, string metaid, int metatype, string url, string title, string desc, string link = "", string imgUrl = "", string type = "", string dataUrl = "")
    {
